...
- **Per-model endpoint routing**:
  ...
  - `doubao-seed-2-0-pro-260215`, `llama-4-scout`, `grok-4-1-fast-reasoning` → `<boyue-https-base-url>` (more stable HTTPS gateway)
  - All others → `<boyue-http-base-url>` (default Boyue gateway)
